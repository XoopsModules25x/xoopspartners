...
define('_AM_XOOPSPARTNERS_TITLE', 'Titre');
define('_AM_XOOPSPARTNERS_WEIGHT', 'Poids');
define('_AM_XOOPSPARTNERS_DESCRIPTION', 'Description');
define('_AM_XOOPSPARTNERS_STATUS', 'Statut');
define('_AM_XOOPSPARTNERS_ACTIVE', 'Actif');
define('_AM_XOOPSPARTNERS_INACTIVE', 'Inactif');
define('_AM_XOOPSPARTNERS_REORDER', 'Trié par');
define('_AM_XOOPSPARTNERS_UPDATED', 'Paramètres mis à jour !');
define('_AM_XOOPSPARTNERS_NOTUPDATED', 'Impossible de mettre à jour les paramètres !');
define('_AM_XOOPSPARTNERS_BESURE', "Assurez-vous d'entrer au moins un titre, une URL et une description.");
define('_AM_XOOPSPARTNERS_NOEXIST', "Le fichier image n'existe pas");
define('_AM_XOOPSPARTNERS_ADDPARTNER', 'Ajouter');
define('_AM_XOOPSPARTNERS_EDITPARTNER', 'Editer');
define('_AM_XOOPSPARTNERS_SUREDELETE', 'Etes-vous sûr de vouloir effacer ce site ?');
define('_AM_XOOPSPARTNERS_IMAGE_ERROR', "La taille de l'image est supérieur à 150x80 !");
define('_AM_XOOPSPARTNERS_ADD', 'Ajouter le partenaire');
define('_AM_XOOPSPARTNERS_AUTOMATIC_SORT', 'Tri automatique');
define('_AM_XOOPSPARTNERS_UPDATE', 'Mise � jour');
...
define('_AM_XOOPSPARTNERS_ADMIN_FOOTER', "<div class='center smallsmall italic pad5'><strong>{$adminMyDirName}</strong> is maintained by the <a class='tooltip' rel='external' href='https://xoops.org/' title='Visit XOOPS Community'>XOOPS Community</a></div>");
